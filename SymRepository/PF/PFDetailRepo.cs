...
namespace SymRepository.PF
{
    public class PFDetailRepo
    {
        ...
        public string[] ImportExcelFile(string fullPath, string fileName, ShampanIdentityVM vm, int FYDId = 0, string PId = "", string TransType="")
        {
            try
            {
                return new PFDetailDAL().ImportExcelFile(fullPath, fileName, vm, null, null, FYDId, PId, TransType);
            }
            catch (Exception ex)
            {
                throw ex;
